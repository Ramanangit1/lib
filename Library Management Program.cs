...
namespace ConsoleApp2
{
    ...
    namespace Library_Mangement_System
    {
        ...
        {
            //Defining a class Book with the required fields
            class Book
            {
                public int bookId;
            ...
            class Program
            {
                ...
                //Password verfication and Required menu 
                ...
                public static void GetBook()
                {
                    ...
                    {
                        Console.WriteLine("Error.Book ID cannot be more than 5 Digits. Please enter a valid Book ID.");
                    ...
                    book.bookIsbn = int.Parse(Console.ReadLine());
                    Console.Write("Total Pages:");
                    book.bookPages = int.Parse(Console.ReadLine());
                    Console.Write("Book Language:");
                    book.bookLanguage = Console.ReadLine();
                    Console.Write("Book LoT:");
                    book.bookLoT = Console.ReadLine();
                    Console.Write("Book Summary:");
                    book.bookSummary = Console.ReadLine();
